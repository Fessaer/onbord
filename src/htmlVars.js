export const  widget1 =
    `<div class="widget-1 hiden-onbord" data-active-onboard='1'>
      <div class="widget-1_text-cantainer">
        ...
        <div class="footer-Group4105">
          ...
          <button><span>НАЧАТЬ</span></button>
        </div>
      </div>
...
export const widget2 = 
    `<div class="container-widget-2 hiden-onbord" data-active-onboard='2'>
      ...
      <div class="widget-2">
        ...
        <div>
          ...
          <div>
            ...
            <button class="widget-small-button"><span>Далее</span></button>
          </div>
        </div>
      </div>
    </div>`
...
export const widget3 = 
    `<div class="widget-3 hiden-onbord" data-active-onboard='3'>
...
export const widget4 = 
    `<div class="container-widget-4 hiden-onbord" data-active-onboard='4'>
...
export const widget5 = 
    `<div class="container-widget-5 hiden-onbord" data-active-onboard='5'>
...
export const widget6 =
    `<div class="container-widget-6 hiden-onbord" data-active-onboard='6'>
...
export const widget7 = 
  `<div class="container-widget-7 hiden-onbord" data-active-onboard='7'>
...
export const widget8 = 
      `<div class="container-widget-8 hiden-onbord" data-active-onboard='8'>
...
export const widget9 = 
      `<div class="container-widget-9 hiden-onbord" data-active-onboard='9'>
